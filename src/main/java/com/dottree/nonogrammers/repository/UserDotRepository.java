...
public interface UserDotRepository extends JpaRepository<UserDot,Integer> {
    ...
    public Long countUserDotByUser_UserIdAndNono_NonoId(int userId, int nonoId);
    ...
    public Long countByUser_UserIdAndNono_NonoIdAndDot_DotId(int userId, int nonoId, int dotId);
